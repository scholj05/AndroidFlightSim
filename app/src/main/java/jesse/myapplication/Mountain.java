...
/**
 * Created by Steven on 11/22/2017.
 */
...
public class Mountain {
     ...
     * @param context
     * @param relativePos
     * @param height value thats lower = higher mountain
     * @param color rgb color for the mountain
     */
    public Mountain(OpenGLRenderer renderer, Context context, Vector3 relativePos, float height, Vector3 color, int size)
    {
        ...
        try {
            ...
            for (int y = 0; y < yLength; y++) {
                for (int x = 0; x < xLength; x++) {
                    ...
                    heightMapVertexData[offset++] = ((xPosition * xPosition) + (yPosition * yPosition)) / height;
                    ...
                    heightMapVertexData[offset++] = color.getX();
                    heightMapVertexData[offset++] = color.getY();
                    heightMapVertexData[offset++] = color.getZ();
        ...
        Matrix.translateM(modelMatrix, 0, relativePos.x, relativePos.y, relativePos.z);
